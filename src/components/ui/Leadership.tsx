  ...
  return (
    <div>
      <div className='relative'>
        <img className='w-full min-h-screen -translate-y-44 ' src='https://assets.lummi.ai/assets/QmW9AKc7BxwDYkum1vri54fKhz5wTnduGyERiUKLM1Qjvr?auto=format&w=1500' />
        <h1 className='absolute top-44 left-24 text-[100px] px-2 font-semibold  border bg-gradient-to-br from-violet-400/20 to-purple-500-20 backdrop-blur-xl   border-r-[12px] border-b-[12px] border-black   text-black'>Leadership</h1>
        </div>
      <div className="container lg:w-[900px] text-center mt-12  mx-auto px-4 py-8">
