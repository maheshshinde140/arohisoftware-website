...
const page = () => {
    return (
        <div>
            <div className='bg-white flex flex-col-reverse lg:flex-row justify-center items-center text-black h-[100vh]'>
            ...
            <div className='bg-gray-200 border text-black'>
                <div className='container lg:w-[80vw] my-5  m-auto'>
                    <h1 className='text-black font-bold text-3xl my-5 lg:text-6xl mb-5'>Chart your course</h1>
                    ...
                    <div className='flex justify-between space-y-5 flex-wrap'>
                        <WorkCard 
