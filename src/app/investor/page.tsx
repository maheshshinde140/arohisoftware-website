...
const page = () => {
  return (
    <div>
      ...
      ></div>
      <div className="relative flex flex-col px-4 py-8 sm:px-8 md:px-12 lg:px-16 xl:px-24 h-screen">
        <h1
        ...
        />
        <div
          className="mt-10 p-6 sm:p-8 bg-opacity-50 rounded-md"
          style={{ textShadow: "4px 4px 8px rgba(0, 0, 0, 0.5)" }}
        >
      ...
      <div className="bg-violet-400 text-black w-full p-6 lg:flex lg:px-16 xl:px-24">
        <div className="lg:w-2/3 lg:py-8 mx-auto">
          ...
          <a href="#">
            <button className="text-violet-700 font-bold rounded-lg hover:bg-violet-700 hover:text-white my-8 p-2 bg-white">
              Explore The Experience
            </button>
          </a>
        </div>
        <div className="bg-white p-5 m-12 h-fit lg:w-1/3 w-full rounded-md">
      ...
      <div className="bg-white text-black py-10">
        <div className="bg-gray-200 text-black">
          <div className="flex flex-col sm:flex-row justify-around gap-5 mx-auto h-fit p-4 sm:p-6 md:p-8">
            <div className="w-full sm:w-1/2 h-fit text-center py-10">
            ...
            <div className="w-full sm:w-1/2 py-10 text-center">
              <h1 className="font-bold lg:text-4xl text-md">
                Register for <br />
                Investor Email Alerts
              </h1>
              <a href="#">
                <button className="hover:text-violet-700 font-bold rounded-lg bg-violet-700 text-white m-2 p-2 hover:bg-white">
                  SignUp
                </button>
              </a>
            </div>
