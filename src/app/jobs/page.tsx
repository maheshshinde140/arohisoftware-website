...
const sharedButtonClasses = " py-2 bg-gradient-to-r  from-yellow-400 to-orange-500 text-white rounded-lg hover:from-yellow-500 hover:to-orange-600 transition duration-300";
...
const JobCard: React.FC = () => {
  return (
    <div className="bg-zinc-800 p-4 rounded-lg shadow-lg hover:shadow-xl transition duration-300">
      <div className="flex justify-between items-center min-w">
...
const jobs: React.FC = () => {
  return (
    <div className="min-h-screen bg-zinc-900 p-4 lg:p-20">
      <div className="max-w-7xl mx-auto">
        <div className="text-center my-14">
          <h1 className="text-xl lg:text-4xl font-bold text-zinc-300">Search Jobs at Arohi Software</h1>
          <div className="mt-4 flex flex-row justify-center items-center">
            <input type="text" placeholder="Use quotation marks for exact matches" className={sharedInputClasses} />
            <button className={`${sharedButtonClasses} px-2 sm:mt-0 sm:ml-2`}>Search</button>
          </div>
        </div>
        <div className="my-8">
          <h2 className="text-2xl font-semibold text-zinc-300">Latest Jobs (57020)</h2>
          <div className="mt-4 flex">
          <span className={`${sharedTextClasses} min-w-fit`}>Sort by:</span>
        ...
        <div className="flex flex-row justify-between space-x-1 items-center mt-8">
          <button className={`${sharedButtonClasses} from-red-400 w-20 mt-4 to-pink-500`}>Previous</button>
          ...
          <button className={`${sharedButtonClasses} from-red-400 w-20 to-pink-500 mt-4 sm:mt-0`}>Next</button>
        </div>
        <div className="my-8">
