      ...
      <div className="w-full bg-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
          <div className="flex flex-col  justify-around pb-8 px-8">
            ...
            And neither do we. We invest more than $1 billion each year in continuous learning and professional development programs, delivering more than 40 million training hours every year. Our award-winning programs include specialized certifications, deep-tech training, workshops, online games, hackathons, virtual reality and more. 
              </p>
          </div>
