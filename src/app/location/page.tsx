...
const LocationPage = () => {
    ...
    return (
        <div className="min-h-screen mt-12 flex w-full flex-col items-center justify-center overflow-x-hidden">
            <Head>
                <title>Contact Us - Arohi Softwares</title>
                <meta name="description" content="Contact us at Arohi Softwares" />
            </Head>
            ...
            <div className="relative w-full overflow-hidden">
                <section className="absolute left-1/2 transform -translate-x-1/2 top-24 bg-white/60 backdrop-blur-lg text-center text-black py-10 z-10 w-11/12 md:w-2/3 lg:w-1/2">
                    <h1 className="text-4xl font-semibold mb-4 text-black">Arohi Softwares IT Company</h1>
                    <p className="text-lg text-black px-6">Find us at our office or get in touch with us for any inquiries. We are here to help you!</p>
                </section>
                <img className="w-full h-96 object-cover -translate-y-11 scale-125 -z-10" src="https://cdn.dribbble.com/users/2096861/screenshots/18532623/media/7567479d6dd3db1282da37267a9cacc6.jpg" alt="Background Image" />
            </div>

            <main className="flex flex-col md:flex-row items-center justify-center w-full p-6 bg-black shadow-lg rounded-lg z-10 overflow-hidden">
                <section className="flex flex-col gap-12 w-full md:w-1/2 p-4">
                    <div className="hover:bg-gradient-to-br p-[2px] from-violet-400 to-orange-300">
                        <button className="group w-full text-left border flex justify-between items-center p-2 bg-white text-black" onClick={() => setLocation({ x: 19.9278796, y: 74.73809 })}>
                            <div>
                                <h3 className="text-3xl">Ahmednagar, Maharashtra</h3>
                                <p>Full Address</p>
                            </div>
                ...
                <div className="w-full md:w-1/2 h-96 md:h-[500px] mt-6 md:mt-0 border-8 rounded-lg overflow-hidden shadow-md">
                    <MapContainer center={[location.x, location.y]} zoom={13} style={{ height: '100%', width: '100%' }}>
                        <TileLayer
                            url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
                        />
            ...
            <h2 className="text-3xl my-12">Get in touch with us</h2>
            <form onSubmit={handleSubmit} className="w-full max-w-2xl px-4 mb-12 space-y-4 text-black shadow-md rounded-lg">
                ...
                <div>
                    ...
                    <textarea
                        ...
                        value={formData.message}
                        onChange={handleChange}
                        className="w-full px-4 py-2 h-32 border border-gray-300 rounded-md"
                        required
                    />
                </div>
                <button type="submit" className="px-4 py-2 bg-gray-800 text-white rounded-md border border-black transition-colors duration-300 w-full">
                    Send Message
                </button>
                <div className="text-center">
                    <p className="text-blue-900">or contact us via phone: <a href="tel:+1234567890" className="text-blue-900">+1 (234) 567-890</a></p>
