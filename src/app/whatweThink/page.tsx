...
import what1 from '../../../public/assets/WhatweThink/what1.avif';
const page = () => {
  return (
    <div>
        ...
        <div className="container  ">
          ...
          <div className="container mt-6">
            <p className=" font-normal text-lg sm:text-3xl ">
              Explore our research, insights, and examples of real <br /> client
              impact, designed to help you embrace the key forces <br /> of
              change and get to value faster.
            </p>
          </div>
        </div>
      </div>
