...
const Page = () => {
  ...
  <div className={`${sharedClasses.maxW7xl} ${sharedClasses.mxAuto} ${sharedClasses.py12} ${sharedClasses.px4} ${sharedClasses.smPx6} ${sharedClasses.lgPx8}`}>
    ...
    <div className={sharedClasses.mt10}>
      <dl className={` grid grid-cols-6 gap-12 lg:w-[80vw] mx-auto`}>
        <div className='grid col-span-3 bg-black border border-whte rounded-lg p-4 '>
        ...
        <div className='grid col-span-3'>
                <div className='border bg-black border-whte rounded-lg p-4'>
                ...
                <div className='border bg-black border-whte rounded-lg p-4 mt-4'>
  ...
  <div className={`${sharedClasses.maxW7xl} ${sharedClasses.mxAuto} ${sharedClasses.py12} ${sharedClasses.px4} ${sharedClasses.smPx6} ${sharedClasses.lgPx8}`}>
    ...
    <div className={sharedClasses.mt10}>
            <dl className={` grid grid-cols-6 gap-12 lg:w-[80vw] mx-auto`}>
              <div className='grid bg-black col-span-3 border border-whte rounded-lg p-4 '>
