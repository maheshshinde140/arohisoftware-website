...
const EventPage: React.FC = () => {
  ...
  return (
    <div className='min-h-screen bg-white overflow-hidden'>
      <div className='pt-36 mx-4 lg:mx-auto lg:translate-x-16 lg:scale-150'>
        <Carousel plugins={[plugin.current]} className="w-[100vw] max-w-[100]" onMouseLeave={plugin.current.reset}>
          <CarouselContent>
