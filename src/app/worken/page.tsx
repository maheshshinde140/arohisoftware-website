    ...
    <div>
      ...
      <div className=" bg-white ">
        <div className="lg:container flex-col-reverse flex justify-around items-center lg:flex-wrap h-[80vh] ">
          ...
          <div className=" lg:w-5/12 m-7">
            <p className="text-black text-3xl lg:text-6xl w-fit text-wrap font-bold">Arohi Work <br></br> Environment</p>
          ...
          <div className="h-[55vh] lg:w-[54%] w-[100vw]" style={{
            backgroundImage:"url('https://dynamicmedia.accenture.com/is/image/accenture/Accenture-work-environment-marquee?qlt=85&wid=1024&ts=1686340609764&fit=constrain&dpr=off')",
      ...
      <div className=" lg:h-[80vh] bg-gray-200 p-5 ">
        <div className="lg:container">
          <p className="text-black lg:text-5xl text-3xl text-center pt-6 font-bold ">Innovating in a truly human way
          </p>
          ...
          <div className="lg:container mt-6 lg:flex justify-around items-center " >
            ...
            <div className="h-[55vh] lg:w-4/12 " style={{
              backgroundImage:
...
<div className='workBalance-container'>
    <p className="text-3xl block font-bold lg:text-6xl p-5">Work your way</p>
...
<WorkCard images='https://dynamicmedia.accenture.com/is/image/accenture/Accenture-work-environment1-768x432?qlt=85&wid=480&ts=1704397328444&fit=constrain&dpr=off' altText='this is img' text='We provide several voluntary options, including job-sharing opportunities, part-time and flex-time schedules.' title="Flexible Schedules" />
<WorkCard images='https://dynamicmedia.accenture.com/is/image/accenture/Accenture-work-environment2-768x432?qlt=85&wid=480&ts=1686340609442&fit=constrain&dpr=off' altText='this is img' text='Work from a location other than a designated Accenture office or project site.' title="Telecommute" />
<WorkCard images='https://dynamicmedia.accenture.com/is/image/accenture/Accenture-work-environment3-768x432?qlt=85&wid=480&ts=1692306911474&fit=constrain&dpr=off' altText='this is img' text='Manage your time away from home with fly-back flights, compressed workweeks, extended weekends and time at client.' title="Client-Site Flexibility" />
    </div>
